...
.PHONY: help check check-prereqs init install install-frontend build start start-backend start-frontend test clean status update eject-frontend

# Default target: show help
help:
	@echo "Deno Live Text-to-Speech - Available Commands"
	@echo "========================================"
	@echo ""
	@echo "Setup:"
